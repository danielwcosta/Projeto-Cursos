<?php
    ...
    require "req/funcoesProdutos.php";
    ...
    if($_POST){
        ...
        if ($_FILES) {
            ...
            if ($_FILES["arquivo"]["error"] == UPLOAD_ERR_OK){
                ...
                $pastaRaiz = dirname(__FILE__);      //imprime a pasta raiz do arquivo
                // echo $pastaRaiz;
                // exit;
    ...
    <h2>Adicionar Produto</h2>
        ...
        <form action="adicionarProduto.php" method="post" class="col-md-7" enctype="multipart/form-data">
            ...
            <div class="col-xs-12">
                ...
                <input type="numeber" id="preco" name="preco" class="form-control">
            </div>
            <div class="col-xs-12">
            ...
            <div class="col-xs-12">
            <br>
                <label for="inputArquivo" class="btn btn-info">Upload da foto do produto</label>
